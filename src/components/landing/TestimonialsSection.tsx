...
export function TestimonialsSection() {
  return (
    <section id="testimonials" className="py-16 sm:py-24 lg:py-32 relative overflow-hidden bg-[#EAF6FB]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          <motion.h2
            ...
            className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#05445E] mb-5 tracking-tight"
          >
          ...
          <motion.p
            ...
            className="max-w-xl mx-auto text-[#3a7fa0] text-base sm:text-lg font-medium"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-8">
          {testimonials.map((t, i) => (
            <motion.div
              ...
              className="bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-8 border border-[#189AB4]/15 shadow-sm hover:shadow-[0_15px_40px_-10px_rgba(24,154,180,0.15)] transition-all flex flex-col justify-between"
            >
              <div>
                <Quote className="w-8 h-8 sm:w-10 sm:h-10 text-[#189AB4]/20 mb-4 sm:mb-6" fill="currentColor" />
