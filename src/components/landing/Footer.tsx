...
export function Footer() {
  return (
    <footer className="bg-[#05445E] text-white pt-12 sm:pt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Top Header - Logo and subtitle */}
        <div className="flex flex-col mb-8 sm:mb-10">
          <Link href="/" className="inline-flex items-center gap-3 font-bold text-2xl sm:text-3xl tracking-wide text-white mb-4">
        ...
        {/* Horizontal Divider */}
        <div className="w-full h-px bg-[#189AB4]/30 mb-8 sm:mb-12"></div>

        {/* Columns */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 sm:gap-10 md:gap-12 mb-10 sm:mb-16">
          
          <div className="col-span-1 md:col-span-3">
            <h4 className="text-[13px] font-bold mb-4 sm:mb-6 text-white uppercase tracking-widest">PRODUCTS</h4>
          ...
          <div className="col-span-1 md:col-span-4">
            <h4 className="text-[13px] font-bold mb-4 sm:mb-6 text-white uppercase tracking-widest">COMPANY</h4>
            <ul className="space-y-4">
          ...
          <div className="col-span-1 md:col-span-4 lg:col-span-5">
            ...
            <form className="flex flex-col sm:flex-row w-full" onSubmit={(e) => e.preventDefault()}>
              <input 
                type="email" 
                placeholder="Enter Your Email" 
                className="bg-white border border-transparent text-sm text-[#05445E] placeholder:text-slate-400 px-4 py-3.5 w-full rounded-lg sm:rounded-l-lg sm:rounded-r-none outline-none transition-colors"
                required
              />
              <button 
                type="submit" 
                className="bg-[#189AB4] hover:bg-[#158197] text-white font-bold text-sm px-6 py-3.5 rounded-lg sm:rounded-r-lg sm:rounded-l-none transition-colors mt-2 sm:mt-0"
              >
                Submit
              </button>
            </form>
      ...
      <div className="bg-[#03202C] py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between text-xs sm:text-sm text-[#A0DFF0] gap-4">
