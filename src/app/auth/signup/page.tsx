...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-white">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-4 sm:px-6 py-6 sm:py-8 md:py-12 relative overflow-y-auto min-h-screen lg:min-h-auto">
        <motion.div
        ...
        >
          ...
          <div className="text-center mb-6 sm:mb-8 md:mb-10">
            <h1 className="text-2xl sm:text-3xl font-extrabold text-[#05445E]">Create your account</h1>
            <p className="mt-2 text-xs sm:text-sm text-slate-500 font-medium">Join the next generation of global trade.</p>
          </div>
          ...
          <div className="flex justify-center mb-6 sm:mb-8">
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div className={`w-9 sm:w-12 h-[2px] mb-5 transition-all duration-300 ${step >= 2 ? 'bg-[#05445E]' : 'bg-slate-200'}`} />
          ...
          {/* Card */}
          <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100">
            <AnimatePresence mode="wait">
              {step === 1 ? (
                ...
                >
                  {/* Name */}
                  <div>
                    <label className="block text-xs sm:text-sm font-bold text-[#05445E] mb-1.5 sm:mb-2">Full Name</label>
                    <div className="relative">
                      ...
                      <input
                        ...
                        required
                        className="w-full pl-9 sm:pl-10 pr-3 sm:pr-4 py-2.5 sm:py-3 rounded-lg sm:rounded-xl text-sm text-[#05445E] bg-slate-50 border border-slate-200 placeholder:text-slate-400 outline-none focus:ring-2 focus:ring-[#189AB4]/20 focus:border-[#189AB4] transition-all"
                      />
                    </div>
                  </div>
                  ...
                  {/* Email */}
                  <div>
                    <label className="block text-xs sm:text-sm font-bold text-[#05445E] mb-1.5 sm:mb-2">Email Address</label>
                    <div className="relative">
                  ...
                  {/* Password */}
                  <div>
                    <label className="block text-xs sm:text-sm font-bold text-[#05445E] mb-1.5 sm:mb-2">Create Password</label>
                    <div className="relative">
                      ...
                      <input
                        ...
                        required
                        className="w-full pl-9 sm:pl-10 pr-10 sm:pr-12 py-2.5 sm:py-3 rounded-lg sm:rounded-xl text-sm text-[#05445E] bg-slate-50 border border-slate-200 placeholder:text-slate-400 outline-none focus:ring-2 focus:ring-[#189AB4]/20 focus:border-[#189AB4] transition-all"
                      />
                  ...
                  {/* Confirm Password */}
                  <div>
                    <label className="block text-xs sm:text-sm font-bold text-[#05445E] mb-1.5 sm:mb-2">Confirm Password</label>
                    <div className="relative">
                      <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400" />
                      <input
                        ...
                        required
                        className={`w-full pl-9 sm:pl-10 pr-10 sm:pr-12 py-2.5 sm:py-3 rounded-lg sm:rounded-xl text-sm text-[#05445E] bg-slate-50 border outline-none focus:ring-2 transition-all ${
                  ...
                  {/* Role Dropdown */}
                  <div>
                    <label className="block text-xs sm:text-sm font-bold text-[#05445E] mb-1.5 sm:mb-2">I am registering as a...</label>
                    <div className="relative">
                      ...
                      <select
                        ...
                        className="w-full pl-9 sm:pl-10 pr-9 sm:pr-10 py-2.5 sm:py-3 rounded-lg sm:rounded-xl text-sm text-[#05445E] font-medium bg-slate-50 border border-slate-200 outline-none focus:ring-2 focus:ring-[#189AB4]/20 focus:border-[#189AB4] transition-all appearance-none cursor-pointer"
                      >
                        {ROLES.map(r => (
                  ...
                  <button
                    ...
                    className="w-full py-3 sm:py-3.5 rounded-lg sm:rounded-xl font-bold text-sm text-white bg-[#05445E] hover:bg-[#189AB4] transition-all disabled:opacity-60 disabled:cursor-not-allowed shadow-lg shadow-blue-900/20 mt-5 sm:mt-6"
                  >
                ...
                >
                  ...
                  <div className="flex items-center justify-between px-3 sm:px-4 py-3 rounded-xl bg-[#D6EFF9]/50 border border-[#189AB4]/20 gap-2">
                  ...
                  {/* OTP Token */}
                  <div>
                    <label className="block text-xs sm:text-sm font-bold text-[#05445E] mb-1.5 sm:mb-2">Verification Code</label>
                    <div className="relative">
                      ...
                      <input
                        ...
                        maxLength={8}
                        inputMode="numeric"
                        className="w-full pl-9 sm:pl-10 pr-3 sm:pr-4 py-3 sm:py-3.5 rounded-lg sm:rounded-xl text-lg sm:text-xl text-[#05445E] bg-slate-50 border border-slate-200 placeholder:text-slate-400 outline-none focus:ring-2 focus:ring-[#189AB4]/20 focus:border-[#189AB4] tracking-[0.22em] sm:tracking-[0.3em] font-mono text-center transition-all"
                      />
                    </div>
                  </div>
